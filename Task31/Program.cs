...
int[] GetSumNegativePosotiveElem(int[] arr)
{
    int sumNegative = 0;
    int sumPositive = 0;
...
PrintArray(array);
int[] sumNegativePositiveElem = GetSumNegativePosotiveElem(array);
...
Console.WriteLine();
Console.WriteLine($"Сумма отрицательных элементов = {sumNegativeElem[0]}");
Console.WriteLine($"Сумма положительных элементов = {sumPositiveElem[1]}");